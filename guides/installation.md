...
- for local browser validation, prefer Playwright over CDP with a user-opened Chrome session; when CDP is unavailable, use an approved equivalent runtime browser path and report which path validated the flow
